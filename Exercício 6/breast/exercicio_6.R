...
source("C:\\Users\\mathe\\OneDrive\\Pós Graduação UFMG\\Exercício 6\\breast\\trainELM.R")
source("C:\\Users\\mathe\\OneDrive\\Pós Graduação UFMG\\Exercício 6\\breast\\YELM.R")
source("C:\\Users\\mathe\\OneDrive\\Pós Graduação UFMG\\Exercício 6\\breast\\trainperceptron.R")
source("C:\\Users\\mathe\\OneDrive\\Pós Graduação UFMG\\Exercício 6\\breast\\yperceptron.R")

data_file <- "C:\\Users\\mathe\\OneDrive\\Pós Graduação UFMG\\Exercício 6\\breast\\breast+cancer+wisconsin+diagnostic (1)\\wdbc.data"

data <- read.csv(data_file, header = FALSE)
data$V1 <- NULL

# Converter Diagnosis para -1 e 1
data$V2 <- ifelse(data$V2 == "M", 1, -1)
...
# Executar o treinamento e teste 50 vezes
